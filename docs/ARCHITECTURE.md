...
本文档描述 Oxcache 库（v0.5.0-rc.2）的架构、设计决策和技术细节。
...
| `kit` | trait-kit 0.5 AsyncKit 集成（OxcacheModule + AsyncHealthCheck + AsyncLifecycle + BuildObserver + ShutdownCoordinator + Decorator） | ❗（选择加入） |
| `testing` | 暴露内部函数供测试使用 | ✅ |
